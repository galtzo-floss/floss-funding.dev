...
RSpec.describe ActivationKey, type: :model do
  ...
  it 'uses flag_shih_tzu for featured' do
    key = described_class.create!(namespace: 'org', key: 'lib', ecosystem: 'ruby', project_name: 'Proj')
  ...
  it 'counter caches activation events' do
    key = described_class.create!(namespace: 'o', key: 'l', ecosystem: 'ruby', project_name: 'Proj')

...
RSpec.describe 'ActivationKey show namespace list', type: :request do
  ...
  it 'shows an index list of all activation keys for the same namespace on the show page' do
    a = ActivationKey.create!(namespace: 'org', key: 'alpha', ecosystem: 'ruby', project_name: 'Proj A')
    b = ActivationKey.create!(namespace: 'org', key: 'beta', ecosystem: 'ruby', project_name: 'Proj B')
    _other_ns = ActivationKey.create!(namespace: 'other', key: 'x', ecosystem: 'ruby', project_name: 'Proj X')
